...
public function buscarUsuario()
   { $objConex=new Conexion();//Instanciar clase Conexion
     $sql="SELECT * FROM USUARIOS WHERE(ID_USUARIO=".$this->id_usuario." && ID_PERFIL='".$this->id_perfil."')";
